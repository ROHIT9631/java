class Dmart2
{
	...
	{
        System.out.println("The Available Chocolates: " + chocolates[0] + "\n" + chocolates[1] + "\n" + chocolates[2] + "\n" + chocolates[3] + "\n" + chocolates[4] + "\n" + chocolates[5]);
		...
		System.out.println("The Available Frozen: " + frozen[0] + ", " + frozen[1] + "\n " +frozen[2] + "\n " + frozen[3] + "\n" + frozen[4]);
		System.out.println("The Available Canned: " + canned[0] + ", " + canned[1] + "\n " +canned[2] + "\n " + canned[3] + "\n" + canned[4]);
		System.out.println("The Available Spices: " + spices[0] + ", " + spices[1] + "\n " +spices[2] + "\n" + spices[3] + "\n" + spices[4]);
